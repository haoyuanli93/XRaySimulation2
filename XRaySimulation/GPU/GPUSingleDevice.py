...
def get_kin_and_jacobian(kin_grid, jacobian_grid,
                         ...
                         num):
    """
    Given kout info, this function derives the corresponding kin_array info.
...
def get_kin_telescope(kin_grid,
                      ...
                      num):
    """
    Given the kout grid, this function return the corresponding kin_array grid for
    the telescope of the chirped pulse amplification device.

    :param kin_grid: This function derive the input wave vectors
    :param kout_grid:
    :param optical_axis: The optical rotation_axis of the telescope
    :param num:
    :return:
    """
    # Step 0: Get the cuda grid idx
...
def get_telescope_diffraction(kout_grid,
    ...
    if idx < num:
        ...
        # Change the image position due to the deviation from the optical rotation_axis
