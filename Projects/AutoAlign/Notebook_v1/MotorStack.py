...
class CrystalTower_x_y_theta_chi:
    def __init__(self, crystal, crystal_loc):
        ...
        self.x = Motors.get_ideal_motors_with_model_for_axis(model="XA10A")
        self.y = Motors.get_ideal_motors_with_model_for_axis(model="ZA10A")
        self.adaptor2 = Motors.AdaptorPlate(height=10e3, dimension=[70e3, 70e3])
        self.th = Motors.get_ideal_motors_with_model_for_axis(model="RA10A")
        self.chi = Motors.get_ideal_motors_with_model_for_axis(model="SA07A", rot_center_height=70e3, axis="z")
...
class Tower_x_y_pi:
    def __init__(self, mirror):
        ...
        self.y = Motors.get_ideal_motors_with_model_for_axis(model="ZA10A")
        self.adaptor2 = Motors.AdaptorPlate(height=10e3, dimension=[70e3, 70e3])
        self.pi = Motors.get_ideal_motors_with_model_for_axis(model="SA07A", rot_center_height=70e3, axis="x")
        self.adaptor3 = Motors.AdaptorPlate(height=39e3, dimension=[70e3, 70e3])
        self.optics = mirror
...
class CrystalTower_miniSD_Scan:
    ...
    def __init__(self,
        ...
        self.delay = Motors.get_ideal_motors_with_model_for_axis(model="XA10A")
        self.adaptor2 = Motors.AdaptorPlate(height=10e3, dimension=[233e3, 288e3])
        self.th1 = Motors.get_ideal_motors_with_model_for_axis(model="RA10A")
        self.th2 = Motors.get_ideal_motors_with_model_for_axis(model="RA10A")
        self.chi = Motors.get_ideal_motors_with_model_for_axis(model="SA07A", rot_center_height=70e3, axis="z")
        self.x = Motors.get_ideal_motors_with_model_for_axis(model="XA07A")
        self.adaptor3 = Motors.AdaptorPlate(height=39e3, dimension=[70e3, 70e3])
...
class Grating_tower:
    ...
    def __init__(self,
        ...
        self.y = Motors.get_ideal_motors_with_model_for_axis(model="XA07A", axis='y')
        self.pi = Motors.get_ideal_motors_with_model_for_axis(model='RA05A', axis='x')
        (self.roll, self.yaw) = Motors.get_ideal_motors_with_model_for_axis(model='SA05A-R2S01', axis='x')
...
class Mirror_tower1:
    ...
    def __init__(self, mirror):
        ...
        self.z = Motors.get_ideal_motors_with_model_for_axis(model="XA10A-L101", axis='z')
        self.x = Motors.get_ideal_motors_with_model_for_axis(model="XA10A", axis='x')
        self.adapter2 = Motors.AdaptorPlate(height=10e3, dimension=[100e3, 250e3])
        self.roll = Motors.get_ideal_motors_with_model_for_axis(model="SA07A", rot_center_height=96e3, axis="z")
        self.adapter3 = Motors.L_Bracket(height=10e3, dimension=[70e3, 70e3])
        self.yaw = Motors.get_ideal_motors_with_model_for_axis(model="SA07A", rot_center_height=70e3, axis="x")
...
class Silicon_tower:
    def __init__(self, crystal):
        ...
        self.y = Motors.get_ideal_motors_with_model_for_axis(model="ZA10A")
        self.z = Motors.get_ideal_motors_with_model_for_axis(model="XA10A", axis='z')
        self.x = Motors.get_ideal_motors_with_model_for_axis(model="XA10A")
        ...
        (self.roll, self.pi) = Motors.get_ideal_motors_with_model_for_axis(model='SA05A-R2S01', axis='y')
...
class TG_Sample_tower:
    def __init__(self, sample, yag_sample, yag1, yag2, yag3):
        ...
        self.x = Motors.get_ideal_motors_with_model_for_axis(model="UTS100CC")
        ...
        self.th = Motors.get_ideal_motors_with_model_for_axis(model="RA05A", axis='y')
